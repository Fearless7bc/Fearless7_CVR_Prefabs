...
function Start()
    ...
    SyncAttach = BoundObjects.SyncAttach.Attach() -- Used to make the "Target" object synced, we have to attach something to the prop spawner. This is to ONLY attach to the prop spawner
    ...
    TargetSpawner = false -- This makes it ignore the prop spawner. Change to True to target the spawner as well
end
